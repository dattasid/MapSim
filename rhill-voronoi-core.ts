...
class Halfedge {
    ...
    constructor(edge:Edge, lSite, rSite) {
        this.site = lSite;
        this.edge = edge;
...
export class Voronoi {
    ...
    beachline:RBTree<Beachsection> = null
    circleEvents:RBTree<CircleEvent> = null
    ...
    equalWithEpsilon = function(a:number,b:number){return this.abs(a-b)<Voronoi.ε;};
    greaterThanWithEpsilon = function(a:number,b:number){return a-b>Voronoi.ε;};
    greaterThanOrEqualWithEpsilon = function(a:number,b:number){return b-a<Voronoi.ε;};
    lessThanWithEpsilon = function(a:number,b:number){return b-a>Voronoi.ε;};
    lessThanOrEqualWithEpsilon = function(a:number,b:number){return a-b<Voronoi.ε;};
...
//
    ...
    createHalfedge (edge, lSite, rSite):Halfedge {
...
// given a particular directrix
    rightBreakPoint = function(arc: Beachsection, directrix:number):number {
        var rArc = arc.rbNext;
        if (rArc) {
...
// A bit modified to minimize code paths
    clipEdge (edge:Edge, bbox: BBox): boolean {
        var ax = edge.va.x,
            ay = edge.va.y,
            bx = edge.vb.x,
            by = edge.vb.y,
